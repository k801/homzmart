            ...
            <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
                ...
                <div>
                    <div class="text-dark d-flex align-items-center mb-0">
                        <a href="#" class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary mr-3">{{ translate('View All Flash Sale') }}</a>
                        <span class=" border-left border-soft-light border-width-2 pl-3">
                            <a href="" class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary">{{ translate('View All Products from This Flash Sale') }}</a>
                        </span>
                    </div>
                </div>
            </div>
                                ...
                                @if ($key >= $init && $key <= $end)
                                    ...
                                    @if ($product != null && $product->published != 0)
                                        ...
                                        <div class="h-100px h-md-200px h-lg-auto flash-deal-item position-relative text-center border-bottom @if($i!=4) border-right @endif has-transition hov-shadow-out z-1">
                                            <a href="" class="d-block py-md-3 overflow-hidden hov-scale-img" title="{{  $product->getTranslation('name')  }}">
                                                <!-- Image -->
        ...
        <div class="container">
            ...
            <div class="" style="background-color: {{ get_setting('todays_deal_bg_color', '#3d4666') }}">
                <div class="text-right px-4 px-xl-5 pt-4 pt-md-3">
                    <a href="" class="fs-12 fw-700 text-white has-transition hov-text-warning">{{ translate('View All') }}</a>
                </div>
                        ...
                        <div class="todays-deal aiz-carousel" data-items="7" data-xxl-items="7" data-xl-items="6" data-lg-items="5" data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows="true" data-dots="false" data-autoplay="true" data-infinite="true">
                            @foreach ($todays_deal_products as $key => $product)
                                <div class="carousel-box h-100 px-3 px-lg-0">
                                    <a href="" class="h-100 overflow-hidden hov-scale-img mx-auto" title="{{  $product->getTranslation('name')  }}">
                                        <!-- Image -->
            ...
            <div class="container">
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <!-- Links -->
                        <div class="d-flex">
                            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="">{{ translate('View All Categories') }}</a>
                        </div>
                    </div>
                                ...
                                <div class="bg-white pt-3 pl-3 pr-3 h-100 hov-scale-img" style="min-height: 240px !important;">
                                    <div class="row">
                                        ...
                                        <div class="col py-3 text-center text-md-left">
                                            <!-- Category Name -->
                                            <h6 class="text-dark mb-3"><a class="text-reset fw-700 fs-14 hov-text-primary" href="">{{ $category->getTranslation('name') }}</a></h6>
                                            <!-- Sub Categories -->
                                            <ul class="mb-3 list-unstyled">
                                                ...
                                                <li class="text-dark mb-2">
                                                    <a class="text-reset fw-400 fs-14 hov-text-primary animate-underline-primary" href="" >{{ \App\Models\Category::find($first_level_id)->getTranslation('name') }}</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="">{{ translate('View All') }}</a>
        ...
        <div class="container">
            <div class="row py-5">
                ...
                <div class="col-xl-4 text-center text-xl-right mt-4">
                    <a href="" class="btn text-white hov-bg-white hov-text-dark border border-width-2 fs-16 px-4" style="border-radius: 28px;background: rgba(255, 255, 255, 0.2);box-shadow: 0px 20px 30px rgba(0, 0, 0, 0.16);">{{ translate('View All Coupons') }}</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <section class="mb-2 mb-md-3 mt-2 mt-md-3">
                <div class="container">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <!-- Links -->
                        <div class="d-flex">
                            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="">{{ translate('View All Products') }}</a>
                        </div>
                    </div>
                    <!-- Banner -->
                                    ...
                                    <div class="aiz-card-box p-2 has-transition bg-white">
                                        <div class="row hov-scale-img">
                                            <div class="col-4 col-md-5 mb-3 mb-md-0">
                                                <a href="" class="d-block overflow-hidden h-auto h-md-150px text-center">
                                            ...
                                            <div class="col">
                                                <h3 class="fw-400 fs-14 text-dark text-truncate-2 lh-1-4 mb-3 h-35px d-none d-sm-block">
                                                    <a href="" class="d-block text-reset hov-text-primary">{{ $classified_product->getTranslation('name') }}</a>
                                                </h3>
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    ...
                    <!-- Links -->
                    <div class="d-flex">
                        <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="">{{ translate('View All Sellers') }}</a>
                    </div>
                </div>
                <!-- Sellers Section -->
                            ...
                            <div class="carousel-box h-100 position-relative text-center border-right border-top border-bottom @if($key==0) border-left @endif has-transition hov-animate-outline">
                                <div class="position-relative px-3" style="padding-top: 2rem; padding-bottom:2rem;">
                                    ...
                                    <div class="position-relative mx-auto size-100px size-md-120px">
                                        <a href="" class="d-flex mx-auto justify-content-center align-item-center size-100px size-md-120px border overflow-hidden hov-scale-img" tabindex="0" style="border: 1px solid #e5e5e5; border-radius: 50%; box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.06);">
                                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                    ...
                                    <h2 class="fs-14 fw-700 text-dark text-truncate-2 h-40px mt-3 mt-md-4 mb-0 mb-md-3">
                                        <a href="" class="text-reset hov-text-primary" tabindex="0">{{ $seller->name }}</a>
                                    </h2>
                                    <!-- Shop Rating -->
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    ...
                    <!-- Links -->
                    <div class="d-flex">
                        <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="">{{ translate('View All Brands') }}</a>
                    </div>
                </div>
                <!-- Brands Section -->

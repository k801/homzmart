...
<div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner" data-value="removed" style="    align-items: center;
    color: #12264b !important;
    display: flex;
    flex-direction: row;
    font-size: 18px;
    font-weight: 500;
    height: 45px;    background: rgb(255, 192, 0);text-align:center">
    <a href="{{ get_setting('topbar_banner_link') }}" class="d-block text-reset m-auto" >

متفوتش عروض العيد 💥 شوف العروض من هنا
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @if (get_setting('vendor_system_activation') == 1)
                        ...
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            <a href="" class="text-secondary fs-12 pr-3 d-inline-block border-width-2 border-right">{{ translate('Become a Seller !')}}</a>
                        </li>
                        <!-- Seller Login -->
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            <a href="" class="text-secondary fs-12 pl-3 d-inline-block">{{ translate('Login to Seller')}}</a>
                        </li>
                    @endif
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white">
    <!-- Search Bar -->
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025" style="background-color:#12264b">
        <div class="container">
                        ...
                        @auth
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0 rounded-0">
                                        ...
                                        @forelse(Auth::user()->unreadNotifications as $notification)
                                            <li class="list-group-item">
                                                @if($notification->type == 'App\Notifications\OrderNotification')
                                                    ...
                                                    <a href="" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                ...
                                <div class="text-center border-top">
                                    <a href="" class="text-secondary fs-12 d-block py-2">
                ...
                <div class="ml-auto mr-0">
                    ...
                    @else
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                            ...
                            <a href="" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login')}}</a>
                            <a href="" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">{{ translate('Registration')}}</a>
                        </span>
                    @endauth
                </div>
            </div>
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative bg-primary h-50px" style="background-color:white !important;color:#12264b !important">
